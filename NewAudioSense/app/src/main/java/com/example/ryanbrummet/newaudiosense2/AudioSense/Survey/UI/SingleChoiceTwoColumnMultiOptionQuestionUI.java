...
public class SingleChoiceTwoColumnMultiOptionQuestionUI extends AbstractSingleSelectionSubComponent {
    ...
    public SingleChoiceTwoColumnMultiOptionQuestionUI(String id, int color, SingleChoiceMultiOptionQuestionContent content,
    ...
    public SingleChoiceTwoColumnMultiOptionQuestionUI(String id, int color, SingleChoiceMultiOptionQuestionContent content, boolean omitDescription) {
    ...
    public void render(Activity activity, Display display, ViewGroup rootView) {
        ...
        if (buttonGroup == null) {
            ...
            if(((SingleChoiceMultiOptionQuestionContent) getContent()).getOptions().size() % 2 == 0) {
                for (int i = 0; i < ((SingleChoiceMultiOptionQuestionContent) getContent()).getOptions().size(); i = i + 2) {
                    ...
                    leftOptionButton.setTextSize(18);
                    ...
                    if(i + 2 >= ((SingleChoiceMultiOptionQuestionContent) getContent()).getOptions().size()) {
                        rightOptionButton.setBackgroundResource(R.drawable.darkbluebutton);
                    } else {
                        rightOptionButton.setBackgroundResource(R.drawable.bluebutton);
                    }
                    rightOptionButton.setTextColor(Color.WHITE);
                    rightOptionButton.setTextSize(18);
